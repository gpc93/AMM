    ...
    <body>
        <div id="page">
            ...
            <c:choose>
                    ...
                    <c:forEach var="prodotto" items="${listaProdotti}" >
                               <tr>
                                ...
                                <td><a href="Venditore?idProdotto=${prodotto.idProdotto}"><img title="modifica" alt="modifica annuncio" src="./img/iconaMod.png" width="20" height="20"></a>
                                    <a href="Venditore?eliminaProdotto=${prodotto.idProdotto}"><img title="elimina" alt="elimina annuncio" src="./img/iconaX.gif" width="20" height="20"></a>
                                </td>
                            </tr> 
                ...
                <p>Modifica del prodotto id: ${idProdotto}</p>
